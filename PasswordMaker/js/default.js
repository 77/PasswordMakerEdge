...
(function () {
    ...
    function completedSetPromise() {
        ...
        ifHidePasswd.checked = Windows.Storage.ApplicationData.current.roamingSettings.values["displayGenerated"] ? true : false;
        ifHidePasswdHandler();
    ...
    function ifHidePasswdHandler(eventInfo) {
        if (ifHidePasswd.checked == true) {
            passwdGenerated.style.color = "transparent";
        } else {
